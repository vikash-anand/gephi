...
/**
 * An abstract class that should be 
 * @author Vikash Anand
 */
public abstract class ReportChart implements ReportComponent {
     ...
     * 
     * <p> The first argument is set as xAxis Title and the second is set as yAxisTitle.
     * @param xAxisTitle
     * @param yAxisTitle 
     */
     ...
     */
    abstract void writePointCoordinates(Map pointCoordinates);
}
